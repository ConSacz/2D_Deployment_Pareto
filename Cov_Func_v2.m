function [coverage] = Cov_Func_v2(alpop,rs,Obstacle_Area,Covered_Area)
...
coverage=round(1-((count1-count2)/count3),2);	                            % function to avoid obstacles
%coverage=(count1/count3);		                                % function to aim on wanted area

%% recover obs in Covered_Area
